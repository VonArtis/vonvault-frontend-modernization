...
const AppRouter: React.FC = () => {
  ...
  const tabScreens = ['dashboard', 'investments', 'crypto', 'profile', 'staking-dashboard', 'staking-flow-convert', 'staking-completion', 'staking-history', 'staking-analytics', 'staking-tiers', 'admin-dashboard', 'admin-users', 'admin-investments', 'admin-crypto', 'admin-plans'];
